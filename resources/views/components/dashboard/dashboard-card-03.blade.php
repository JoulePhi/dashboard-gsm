<div
    ...
    <div class="px-2 pt-2">
        <header class="flex flex-row items-start mb-2">
            <!-- Icon -->
            <img src="{{ asset('images/temparature.png') }}" width="32" height="32" alt="Icon 01" />

            <h2 class="text-lg font-semibold text-slate-800 dark:text-slate-100 mb-2 ml-2">Suhu</h2>
        </header>
    </div>
